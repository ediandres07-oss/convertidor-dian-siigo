...
NIT_DETAIL_MAP = {
    # ── Desde balance 2025 ──────────────────────────────────────────────────
    "15378117":   ("51454001", "24081501", None),  # ORLANDO ANTONIO MONTOYA GOMEZ
    "15378281":   ("51953501", "24081001", 1),     # HUGO ALBEIRO TORO CARDONA — combustible
    "15378576":   ("51454001", "24081001", 1),     # LUIS ADELFIO RIOS CARDONA
    "15441517":   ("51454001", "24081501", None),  # LEONARDO ALBERTO MARTINEZ GUARIN
    "15442412":   ("51952501", "24081501", None),  # RAFAEL ALEXANDER SALAZAR SALAZAR
    "15445134":   ("51959501", "24081501", None),  # JOHN JAIRO GARCIA DIAZ
    "21481563":   ("51454001", "24081501", None),  # LUZ DARY MONTOYA GALLO
    "39188564":   ("51201001", "24081001", 1),     # DORIS EUGENIA BEDOYA CHICA — arrendamiento
    "39455072":   ("51952501", "24081501", None),  # RUTH RAMIREZ ARANGO
    "41658695":   ("51055101", "24081501", None),  # ROSA AURORA CARVAJAL BARRIGA — dotación
    "42995046":   ("51103001", "24081001", 1),     # OLGA LUCIA LOAIZA OSSA — asesoría
    "71111818":   ("51952501", "24081501", None),  # FRANCISCO JAVIER ALZATE LOPEZ
    "71113787":   ("51454001", "24081001", 1),     # OMAR DE JESUS OROZCO GOMEZ
    "71117018":   ("51454001", "24081001", 1),     # OSWALDO DE JESUS ZULUAGA GIRALDO
    "71641441":   ("51454001", "24081501", None),  # WILLIAM DE JESUS DUQUE GOMEZ
    "800015551":  ("51401001", "24081001", 1),     # CAMARA DE COMERCIO — registro mercantil
    "800088702":  ("51056901", "24081001", 1),     # CIA SURAMERICANA SALUD — EPS
    "800106884":  ("51055101", "24081501", None),  # DUGOTEX S.A — dotación
    "800180330":  ("51950501", "24081001", 1),     # CALCO S.A. — comisiones
    "800224808":  ("51057001", "24081001", 1),     # PORVENIR — pensiones
    "800227940":  ("51057001", "24081001", 1),     # Colfondos — pensiones
    "800229739":  ("51057001", "24081001", 1),     # PROTECCION — pensiones
    "800242106":  ("51454001", "24081501", None),  # SODIMAC COLOMBIA S.A.
    "800251569":  ("51354001", "24081001", 1),     # INTER RAPIDISIMO — correo/fletes
    "805018674":  ("51352001", "24081501", None),  # ECOM S A S — procesamiento datos
    "811009893":  ("51454001", "24081501", None),  # MACROLLANTAS SAS
    "811019540":  ("51159501", "24081501", None),  # BOMBEROS — otros impuestos
    "811031311":  ("51454001", "24081001", 1),     # CERO 70 S.A.S.
    "811034562":  ("51952501", "24081001", 1),     # LA RECETA Y CIA S.A.S.
    "811036256":  ("51352001", "24081501", None),  # INTERCOMSAS — procesamiento datos
    "830048145":  ("51352001", "24081501", None),  # SIIGO SAS — procesamiento datos
    "830059699":  ("51352001", "24081501", None),  # Satrack — procesamiento datos
    "830112317":  ("51950501", "24081501", None),  # PROMOTORA DE CAFE — comisiones
    "830114921":  ("51353502", "24081501", None),  # COLOMBIA MOVIL — celular
    "830122566":  ("51353502", "24081001", 1),     # COLOMBIA TELECOMUNICACIONES — celular
    "860002184":  ("51304001", "24081501", None),  # AXA COLPATRIA SEGUROS
    "860002400":  ("51304001", "24081501", None),  # LA PREVISORA SEGUROS
    "860027404":  ("51304001", "24081501", None),  # ALLIANZ SEGUROS DE VIDA
    "860039988":  ("51304001", "24081501", None),  # HDI SEGUROS COLOMBIA
    "860508462":  ("51304001", "24081501", None),  # HDI COMPAÑIA DE INVERSIONES
    "890900081":  ("51454001", "24081001", 1),     # AUTOLARTE PIEZAS
    "890900841":  ("51057201", "24081001", 1),     # COMFAMA — caja compensación
    "890900943":  ("51454001", "24081501", None),  # COLOMBIANA DE COMERCIO
    "890903407":  ("51304001", "24081501", None),  # SEGUROS GENERALES SURAMERICANA
    "890903790":  ("51304001", "24081001", 1),     # SEGUROS DE VIDA SURAMERICANA
    "890939936":  ("51251001", "24081001", 1),     # SOCIEDAD MEDICA RIONEGRO — afiliaciones
    "890981207":  ("51150501", "24081001", 1),     # MUNICIPIO LA CEJA — industria y comercio
    "890982616":  ("51150501", "24081001", 1),     # MUNICIPIO EL CARMEN — industria y comercio
    "899999034":  ("51057801", "24081001", 1),     # SENA — aportes SENA
    "899999239":  ("51057501", "24081001", 1),     # ICBF — aportes ICBF
    "900079535":  ("51454001", "24081501", None),  # POLOLUJOS S A
    "900092385":  ("52353501", "24081501", None),  # UNE EPM — teléfono
    "900201094":  ("51952001", "24081001", 1),     # Nuestra Cocina Artesanal — representación
    "900219834":  ("51154001", "24081501", None),  # Fdosx Sas — de vehículos
    "900276962":  ("51552001", "24081501", None),  # D1 S A S — gastos de viaje
    "900336004":  ("51057001", "24081001", 1),     # COLPENSIONES — pensiones
    "900338277":  ("51454001", "24081501", None),  # CDA LOS CRISTALES S.A.S.
    "900391666":  ("51251001", "24081001", 1),     # Salud Domiciliaria 24H — afiliaciones
    "900424941":  ("51055101", "24081501", None),  # QUIRAMA ASOCIADOS — dotación
    "900569531":  ("51454001", "24081501", None),  # AUTOLAND SAS
    "900599627":  ("51950501", "24081501", None),  # INSUFLORES DA S.A.S. — comisiones
    "900720039":  ("51950501", "24081501", None),  # CENTRO DE SERVICIOS C&C — comisiones
    "900806620":  ("51352001", "24081501", None),  # MUNDO + S.A.S — procesamiento datos
    "900933915":  ("51454001", "24081501", None),  # SERVICAUCHOS Y CORREAS S.A.S
    "900972974":  ("51103001", "24081501", None),  # COERGOSST S.A.S. — asesoría
    "900996769":  ("51055101", "24081501", None),  # GUANTES TERRY S.A.S — dotación
    "901095934":  ("51953501", "24081001", 1),     # GRUPO LOS TAMBOS — combustible
    "901113791":  ("51952001", "24081001", 1),     # INVERSIONES PIGASUS — representación
    "901123242":  ("51953001", "24081501", None),  # DISTRIBUCIONES FARGORIENTE — útiles
    "901151055":  ("51452001", "24081501", None),  # CERVEH S.A.S. — equipo oficina
    "901151070":  ("51454001", "24081501", None),  # INVERSIONES OCHOA AGUDELO
    "901168195":  ("51454001", "24081501", None),  # TALLER AUTOWASH MULTISERVICIOS
    "901304273":  ("51956001", "24081001", 1),     # ORGANIZACION GEO — casino
    "901376585":  ("51055101", "24081501", None),  # GRUPO NORDIKO SAS — dotación
    "901406550":  ("51350501", "24081501", None),  # SEGURMAX SEGURIDAD — aseo/vigilancia
    "901714655":  ("51953001", "24081501", None),  # SOLUTECNIC — útiles
    "901799395":  ("51956001", "24081501", None),  # SMARTCOCINA SAS — casino
    # ── NITs sin balance (proveedores nuevos o de otro período) ─────────────
    "1022092204": ("51454001", "24081001", 1),
    "1038333727": ("51454001", "24081001", 1),
    "1038334816": ("51454001", "24081001", 1),
    "1040034345": ("51952501", "24081001", 1),     # ROBINSON ANDRES OSPINA — aseo
    "1098757457": ("51454001", "24081001", 1),
    "15400875":   ("51509501", "24081501", None),  # gastos legales
    "15404656":   ("51454001", "24081001", 1),
    "21667787":   ("51454001", "24081001", 1),
    "2995970":    ("52603501", "24081001", 1),     # HELIER MORENO (propietario)
    "32349185":   ("51454001", "24081001", 1),
    "3603022":    ("51953501", "24081001", 1),     # combustible
    "43161428":   ("51454001", "24081001", 1),
    "70051912":   ("51509501", "24081001", 1),
    "70162940":   ("51953501", "24081001", 1),     # combustible especial
    "70602269":   ("51454001", "24081001", 1),
    "800048847":  ("51953501", "24081001", 1),     # JCR COMBUSTIBLE
    "800153993":  ("52353501", "24081501", None),  # COMCEL
    "805012610":  ("51454001", "24081001", 1),
    "811004112":  ("51454001", "24081001", 1),     # DISPARTES PIEZAS
    "811015158":  ("51953501", "24081001", 1),     # ZUPETROL COMBUSTIBLE
    "811019874":  ("51454001", "24081001", 1),
    "811023037":  ("51953001", "24081001", 1),     # papelería
    "811027052":  ("51454001", "24081001", 1),
    "811027786":  ("51454001", "24081001", 1),     # ECOLLANTAS PIEZAS
    "811036875":  ("51454001", "24081001", 1),
    "811039882":  ("51454001", "24081001", 1),
    "811044263":  ("51454001", "24081001", 1),     # CARPAS Y LUBRICANTES
    "860002400":  ("51304001", "24081501", None),  # LA PREVISORA SEGUROS
    "890902872":  ("51454001", "24081001", 1),
    "890904996":  ("51454001", "24081001", 1),
    "890984843":  ("51454001", "24081001", 1),
    "900116036":  ("51454001", "24081001", 1),
    "900160139":  ("51953501", "24081001", 1),     # EDS LA VARIANTE COMBUSTIBLE
    "900344127":  ("51454001", "24081001", 1),
    "900459737":  ("51953501", "24081001", 1),     # GRUPO EDS AUTOGAS COMBUSTIBLE
    "900491889":  ("51953501", "24081001", 1),     # EDS TERPEL COMBUSTIBLE
    "900541746":  ("51454001", "24081001", 1),
    "900704090":  ("51454001", "24081001", 1),     # RINCARD PIEZAS
    "900758571":  ("51454001", "24081001", 1),
    "901031400":  ("51454001", "24081001", 1),     # FERROPARTES PIEZAS
    "901076394":  ("51953501", "24081001", 1),     # NEOINVERCALO COMBUSTIBLE
    "901105704":  ("51454001", "24081001", 1),
    "901113085":  ("51454001", "24081001", 1),
    "901113902":  ("51454001", "24081001", 1),     # ELECTRICOS LA CABANA PIEZAS
    "901118254":  ("51454001", "24081001", 1),
    "901124504":  ("51354001", "24081501", None),  # Harinas del Sinu — fletes/correo
    "901150329":  ("51454001", "24081001", 1),
    "901218235":  ("51454001", "24081001", 1),     # HIDRAULICAS Y REPUESTOS PIEZAS
    "901253560":  ("51454001", "24081001", 1),     # TORNIRACORES PIEZAS
    "901259705":  ("51454001", "24081001", 1),
    "901269431":  ("51454001", "24081001", 1),     # LUBRIMEDELLIN PIEZAS
    "901335972":  ("51454001", "24081001", 1),
    "901340988":  ("51454001", "24081001", 1),     # CAJAS FUERTES PIEZAS
    "901351826":  ("51454001", "24081001", 1),
    "901553102":  ("51055101", "24081001", 1),     # JOSAOS ADECUACIONES
    "901565059":  ("51454001", "24081001", 1),     # ELECTRILUJOS PIEZAS
    "901575667":  ("51454001", "24081501", None),  # CDA OCCIDENTE PIEZAS
    "901644399":  ("51454001", "24081501", None),  # CDA SAN GERMAN PIEZAS
    "901783612":  ("51454001", "24081001", 1),
    "901826538":  ("51953001", "24081001", 1),     # PAPELERIA MUNDIAL — útiles
    "901903899":  ("51454001", "24081001", 1),     # RINES Y LLANTAS PIEZAS
    "98585449":   ("51454001", "24081001", 1),
}

# Defaults para proveedores nuevos no mapeados
DEFAULT_CUENTA_GASTO = "51454001"
